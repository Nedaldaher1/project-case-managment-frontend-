...
const Management = () => {
 ...
 grid-cols-1 gap-8  max-w-4xl w-full">
            
                {/* قسم الإدخال */}
                <Link 
                    to={`add?type=${type}`} 
                    className={`relative w-[50%] group h-72 rounded-[2.5rem] overflow-hidden transition-all duration-500 hover:scale-105 shadow-xl backdrop-blur-lg border-2 ${
                        isDarkMode
